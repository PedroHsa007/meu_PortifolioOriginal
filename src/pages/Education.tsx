  ...
  const educationItems: EducationItem[] = [
    {
      ...
      period: "2021 - atual",
      status: "Em andamento",
      description: "8º Período. Foco em desenvolvimento de software, banco de dados e análise de sistemas.",
        ...
        <div className="section-container">
          ...
          >
            ...
            <p className="text-gray-300">
              Atualmente estou cursando o 8º período de Sistemas de Informação na FOA, onde tenho me dedicado 
              especialmente às áreas de desenvolvimento de software, análise de dados e inteligência artificial e Suporte ao usuário.
            </p>
          </motion.div>
        </div>
      </div>
