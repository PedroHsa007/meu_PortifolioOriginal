        ...
        <div className="section-container flex flex-col md:flex-row items-center">
          ...
          >
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-blue-500 shadow-lg shadow-blue-500/20">
                <img
                  src="https://media.licdn.com/dms/image/v2/D4D03AQEWC91FAV0XkA/profile-displayphoto-shrink_800_800/B4DZayJKWdHsAg-/0/1746745472652?e=1753920000&v=beta&t=T3xGsYMxLcQjj_qWh3woBHWBob5V-nSwXLCf_q1I0Hw"
                  alt="Pedro Henrique"
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="text-blue-500 block">Pedro Henrique</span>
            </h1>
            <p className="text-xl text-gray-300 mb-6">
              "Estudante de Sistemas de Informação apaixonado por tecnologia e inovação."
            </p>
            <p className="text-gray-400 mb-8">
              Tenho 24 anos e estou construindo minha carreira no mundo da tecnologia. Sou apaixonado por desenvolvimento de software, 
              automação e análise de dados. Atualmente, estou focado em expandir meus conhecimentos em Python, React e tecnologias relacionadas 
              a IA, enquanto aplico minhas habilidades em projetos reais.
            </p>
