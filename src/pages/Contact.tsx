...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <MapPin size={24} />,
      title: 'Localização',
      details: 'Volta Redonda, RJ - Brasil',
      color: 'text-red-500',
    },
  ];
            ...
            >
              <div>
                ...
                <p className="text-gray-400 mb-8">
                 Estou em busca de oportunidades profissionais nas áreas de Suporte Técnico e Análise de Dados.
                 Se você tem uma vaga, proposta ou quer trocar ideias sobre esses temas, ficarei feliz em conversar!
                </p>
              </div>
